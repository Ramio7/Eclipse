...
namespace Unity.Mathematics.Tests
{
    ...
    public class TestUint3x4
    {
        ...
        {
            TestUtils.AreEqual(0u, uint3x4.zero.c0.x);
            TestUtils.AreEqual(0u, uint3x4.zero.c0.y);
            TestUtils.AreEqual(0u, uint3x4.zero.c0.z);
            TestUtils.AreEqual(0u, uint3x4.zero.c1.x);
            TestUtils.AreEqual(0u, uint3x4.zero.c1.y);
            TestUtils.AreEqual(0u, uint3x4.zero.c1.z);
            TestUtils.AreEqual(0u, uint3x4.zero.c2.x);
            TestUtils.AreEqual(0u, uint3x4.zero.c2.y);
            TestUtils.AreEqual(0u, uint3x4.zero.c2.z);
            TestUtils.AreEqual(0u, uint3x4.zero.c3.x);
            TestUtils.AreEqual(0u, uint3x4.zero.c3.y);
            TestUtils.AreEqual(0u, uint3x4.zero.c3.z);
        }
        ...
        public static void uint3x4_EqualsObjectOverride()
        {
            ...
            TestUtils.IsTrue(new uint3x4().Equals((object)new uint3x4()));
        }
