...
namespace Unity.Mathematics.Tests
{
    ...
    public class TestUint3x3
    {
        ...
        {
            TestUtils.AreEqual(0u, uint3x3.zero.c0.x);
            TestUtils.AreEqual(0u, uint3x3.zero.c0.y);
            TestUtils.AreEqual(0u, uint3x3.zero.c0.z);
            TestUtils.AreEqual(0u, uint3x3.zero.c1.x);
            TestUtils.AreEqual(0u, uint3x3.zero.c1.y);
            TestUtils.AreEqual(0u, uint3x3.zero.c1.z);
            TestUtils.AreEqual(0u, uint3x3.zero.c2.x);
            TestUtils.AreEqual(0u, uint3x3.zero.c2.y);
            TestUtils.AreEqual(0u, uint3x3.zero.c2.z);
        }

        [TestCompiler]
        public static void uint3x3_identity()
        {
            TestUtils.AreEqual(1u, uint3x3.identity.c0.x);
            TestUtils.AreEqual(0u, uint3x3.identity.c0.y);
            TestUtils.AreEqual(0u, uint3x3.identity.c0.z);
            TestUtils.AreEqual(0u, uint3x3.identity.c1.x);
            TestUtils.AreEqual(1u, uint3x3.identity.c1.y);
            TestUtils.AreEqual(0u, uint3x3.identity.c1.z);
            TestUtils.AreEqual(0u, uint3x3.identity.c2.x);
            TestUtils.AreEqual(0u, uint3x3.identity.c2.y);
            TestUtils.AreEqual(1u, uint3x3.identity.c2.z);
        }
        ...
        public static void uint3x3_EqualsObjectOverride()
        {
            ...
            TestUtils.IsTrue(new uint3x3().Equals((object)new uint3x3()));
        }
