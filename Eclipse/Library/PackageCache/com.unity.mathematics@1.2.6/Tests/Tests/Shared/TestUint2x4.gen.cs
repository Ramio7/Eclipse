...
namespace Unity.Mathematics.Tests
{
    ...
    public class TestUint2x4
    {
        ...
        {
            TestUtils.AreEqual(0u, uint2x4.zero.c0.x);
            TestUtils.AreEqual(0u, uint2x4.zero.c0.y);
            TestUtils.AreEqual(0u, uint2x4.zero.c1.x);
            TestUtils.AreEqual(0u, uint2x4.zero.c1.y);
            TestUtils.AreEqual(0u, uint2x4.zero.c2.x);
            TestUtils.AreEqual(0u, uint2x4.zero.c2.y);
            TestUtils.AreEqual(0u, uint2x4.zero.c3.x);
            TestUtils.AreEqual(0u, uint2x4.zero.c3.y);
        }
        ...
        public static void uint2x4_EqualsObjectOverride()
        {
            ...
            TestUtils.IsTrue(new uint2x4().Equals((object)new uint2x4()));
        }
