...
public class DoubleJumpAbilityView : BaseMainCharacterAbilityView
{
    ...
    protected override async void InitAsync()
    {
        ...
        abilityBindPanel.Ability = new DoubleJumpAbility(EntryPointView.MainScreenCharacter, (JumpAbility)PlayerAbilitiesPool.GetMainCharacterAbility<JumpAbility>(), defaults.SecondJumpForce);
    }
}
