...
public class SettingsMenuScriptableObject : BaseScriptableObject
{
    ...
    [SerializeField, Range(0f, 1f)] private float _defaultSoundVolume;
    [SerializeField, Range(0f, 1f)] private float _defaultMusicVolume;
    [SerializeField, Range(0f, 1f)] private float _effectVolume;
    [SerializeField, Range(0f, 1f)] private float _voiceVolume;
    [SerializeField, Range(0f, 1f)] private float _contrastRatio;
    [SerializeField, Range(0f, 1f)] private float _defaultBrightnessVolume;
